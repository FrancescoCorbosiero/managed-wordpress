...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             *
             * Production: BACKUP_DISK=s3 → Contabo Object Storage.
             * Local dev: BACKUP_DISK=local writes under storage/app/private.
             */
            'disks' => [
    ...
    'notifications' => [
        ...
        'mail' => [
            // Set BACKUP_NOTIFICATION_EMAIL in .env to receive alerts.
            // Falls back to MAIL_FROM_ADDRESS so notifications are well-formed
            // even when no operator address is configured yet.
