/**
 * Testimonials Block - Editor Registration
 */
(function(wp) {
        ...
        edit: function(props) {
            ...
            return el('div', blockProps,
                el('div', {
                    ...
                    el('span', { className: 'dashicons dashicons-format-quote', style: { fontSize: '36px', color: '#d4af37', marginBottom: '12px', display: 'block' } }),
