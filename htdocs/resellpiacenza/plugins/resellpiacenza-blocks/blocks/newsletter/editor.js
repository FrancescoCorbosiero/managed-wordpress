/**
 * Newsletter Block - Editor Registration
 */
(function(wp) {
            ...
            return el('div', blockProps,
                el('div', {
                    ...
                    style: {
                        padding: '40px',
                        textAlign: 'center',
                        background: 'linear-gradient(135deg, #f8f6f0 0%, #f5f3ef 100%)',
                        borderRadius: '12px',
                        border: '1px solid #e8e5df'
                    }
                },
                    el('span', { className: 'dashicons dashicons-email', style: { fontSize: '36px', color: '#0a192f', marginBottom: '12px', display: 'block' } }),
