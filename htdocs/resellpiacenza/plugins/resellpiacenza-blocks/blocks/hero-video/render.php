<?php
/**
 * Hero Video Block - Server-side render
 */
...
$block_id = 'rp-hero-' . wp_unique_id();
?>
<section class="rp-block rp-hero-video" data-rp-hero-video id="<?php echo esc_attr($block_id); ?>">
    <div class="rp-hero-video__media">
    ...
    <div class="rp-hero-video__overlay"></div>

    <div class="rp-hero-video__content">
        <?php if (!empty($badge)) : ?>
            <span class="rp-hero-video__badge">
        ...
        <h1 class="rp-hero-video__title" data-rp-split="chars"><?php echo esc_html($title); ?></h1>

        <?php if (!empty($subtitle)) : ?>
            <p class="rp-hero-video__subtitle"><?php echo esc_html($subtitle); ?></p>
        <?php endif; ?>

        <?php if (!empty($primary_btn_url) || !empty($secondary_btn_url)) : ?>
            <div class="rp-hero-video__cta">
    ...
    <?php if ($show_scroll) : ?>
        <div class="rp-hero-video__scroll">
            <span>Scroll</span>
