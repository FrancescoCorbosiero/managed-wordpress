(function(wp) {
    ...
    var ALLOWED_BLOCKS = ['edizioni-rosi/book-card'];

    registerBlockType('edizioni-rosi/book-grid', {
        edit: function(props) {
            ...
            return el(Fragment, null,
                ...
                el('div', { className: 'er-editor-placeholder' },
                    el('div', { className: 'er-editor-placeholder__title' },
                        'Book Grid' + (sectionTitle ? ' \u2014 ' + sectionTitle : '')
                    ),
                    el('div', { className: 'er-editor-placeholder__text' },
                        'Aggiungi book-card come blocchi interni.'
                    ),
                    el('div', { style: { marginTop: '16px' } },
                        el(InnerBlocks, {
                            allowedBlocks: ALLOWED_BLOCKS,
                            template: [['edizioni-rosi/book-card', {}]],
